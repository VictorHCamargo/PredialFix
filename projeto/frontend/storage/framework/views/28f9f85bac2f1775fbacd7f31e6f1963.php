<footer class="bg-senai-red mt-8">
    <div class="mx-auto grid max-w-5xl grid-cols-1 gap-8 px-6 py-8 md:grid-cols-2">
        <div class="text-white">
            ...
            <p class="text-sm leading-relaxed text-red-100">Av. Paulista, 1313, São Paulo/SP<br />
            CEP 01311-923</p>
        </div>
...
<?php /**PATH C:\laragon\www\PredialFix\projeto\frontend\resources\views/components/footer.blade.php ENDPATH**/ ?>