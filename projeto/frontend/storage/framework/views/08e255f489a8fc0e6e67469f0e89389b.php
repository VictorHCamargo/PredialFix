            ...
            <div class="grid grid-cols-1 gap-4 md:grid-cols-2">
                ...
                <div>
                    ...
                    <select id="nivel_acesso" name="nivel_acesso" required class="w-full rounded border border-gray-300 px-4 py-3 text-sm focus:outline-none focus:ring-2 focus:ring-red-500">
                        ...
                        <option value="gerente_manutencao" <?php if(old('nivel_acesso') === 'gerente_manutencao'): echo 'selected'; endif; ?>>Gerente de manutencao</option>
                        ...
                        <option value="aluno" <?php if(old('nivel_acesso') === 'aluno'): echo 'selected'; endif; ?>>Aluno</option>
                    </select>
                </div>
