        ...
        <div class="mb-8 grid grid-cols-2 gap-4 md:grid-cols-4">
            ...
            >
                ...
                <div>
                    ...
                    <p class="text-2xl font-bold leading-tight text-gray-800">{{ $total }}</p>
                </div>
            </div>
                    ...
                    <div class="flex flex-wrap items-end gap-3">
                        ...
                        <div>
                            ...
                            >
                                ...
                                <option
                                    value="interno"
                                    @selected (request('tipo_chamado') === 'interno')
                                    >Interno
                                </option>
                                <option
                                    value="externo"
                                    @selected (request('tipo_chamado') === 'externo')
                                    >Externo
                                </option>
                            </select>
                        </div>
                        ...
                        <div>
                            ...
                            >
                                ...
                                <option value="alta" @selected (request('prioridade') === 'alta')
                                    >Alta
                                </option>
                                <option value="media" @selected (request('prioridade') === 'media')
                                    >Média
                                </option>
                                <option value="baixa" @selected (request('prioridade') === 'baixa')
                                    >Baixa
                                </option>
                            </select>
                        </div>
                            ...
                            <tr class="border-b border-gray-200 transition hover:bg-gray-50">
                                ...
                                <td class="border-r border-gray-300 px-4 py-3 text-xs">
                                    @if ($chamado->prioridade)
                                        ...
                                        @endphp
                                        <span
                                            class="inline-block {{ $priorityColors[$chamado->prioridade] ?? '' }} px-2 py-1 rounded font-semibold"
                                        >
                                ...
                                <td class="border-r border-gray-300 px-4 py-3 text-xs">
                                    ...
                                    @endphp
                                    <span
                                        class="inline-block {{ $statusColors[$chamado->status] ?? '' }} px-2 py-1 rounded font-semibold"
                                    >
                                        {{
                                            ucfirst(
