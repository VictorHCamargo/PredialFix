...
<body class="flex min-h-screen flex-col bg-gray-50 font-sans">
    ...
    <div
        ...
        class="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50 @if (!$errors->has('senha_atual') && !$errors->has('senha_nova')) hidden @endif"
    >
    ...
    <div
        ...
        class="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50 @if (!$errors->has('senha')) hidden @endif"
    >
        <div class="mx-4 w-full max-w-sm rounded-lg bg-white p-6 shadow-lg">
