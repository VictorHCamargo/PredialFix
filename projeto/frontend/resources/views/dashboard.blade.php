        ...
        <div class="mb-8 grid gap-4 grid-cols-2 md:grid-cols-4">
            ...
            <div class="flex items-center gap-3 rounded border border-gray-200 bg-white px-4 py-4 shadow hover:shadow-md transition">
                ...
                <div>
                    ...
                    <p class="text-2xl font-bold leading-tight text-gray-800">{{ $totalUsuarios ?? 0 }}</p>
                </div>
            </div>
            ...
            <div class="flex items-center gap-3 rounded border border-gray-200 bg-white px-4 py-4 shadow hover:shadow-md transition">
                ...
                <div>
                    ...
                    <p class="text-2xl font-bold leading-tight text-gray-800">{{ $totalChamados ?? 0 }}</p>
                </div>
            </div>
            ...
            <div class="flex items-center gap-3 rounded border border-gray-200 bg-white px-4 py-4 shadow hover:shadow-md transition">
                ...
                <div>
                    ...
                    <p class="text-2xl font-bold leading-tight text-gray-800">{{ $chamadosPendentes ?? 0 }}</p>
                </div>
            </div>
            ...
            <div class="flex items-center gap-3 rounded border border-gray-200 bg-white px-4 py-4 shadow hover:shadow-md transition">
                ...
                <div>
                    ...
                    <p class="text-2xl font-bold leading-tight text-gray-800">{{ $chamadosResolvidosHoje ?? 0 }}</p>
                </div>
            </div>
        </div>
        ...
        <div class="grid gap-8 lg:grid-cols-3">
                                    ...
                                    <div class="flex-1 min-w-0">
                                        <div class="flex items-center gap-3 mb-2">
                                            <p class="font-semibold text-gray-800 truncate">
                                                {{ $chamado->tipoProblema?->nome ?? 'Tipo não especificado' }}
                                            </p>
                                            @php
                                                $statusMap = [
                                            ...
                                            @endphp
                                            <span class="text-xs font-medium px-2 py-1 rounded {{ $s['class'] }}">
                                                {{ $s['label'] }}
                                            </span>
                                        </div>
                                        <p class="text-sm text-gray-600 mb-2">
                                            {{ Str::limit($chamado->descricao, 60) }}
                                        </p>
            ...
            <div>
                    ...
                    <div class="divide-y divide-gray-200">
                        <div class="px-6 py-4">
                            <div class="flex items-center justify-between mb-2">
                                ...
                                <p class="text-lg font-bold text-gray-800">{{ $emAndamento ?? 0 }}</p>
                            </div>
                            <div class="w-full bg-gray-200 rounded-full h-2">
                                <div class="bg-yellow-500 h-2 rounded-full" style="width: {{ $totalChamados > 0 ? (($emAndamento ?? 0) / ($totalChamados ?? 1) * 100) : 0 }}%"></div>
                            </div>
                        </div>
                        ...
                        <div class="px-6 py-4">
                            <div class="flex items-center justify-between mb-2">
                                ...
                                <p class="text-lg font-bold text-gray-800">{{ $concluidos ?? 0 }}</p>
                            </div>
                            <div class="w-full bg-gray-200 rounded-full h-2">
                                <div class="bg-green-500 h-2 rounded-full" style="width: {{ $totalChamados > 0 ? (($concluidos ?? 0) / ($totalChamados ?? 1) * 100) : 0 }}%"></div>
                            </div>
                        </div>
                        ...
                        <div class="px-6 py-4">
                            <div class="flex items-center justify-between mb-2">
                                ...
                                <p class="text-lg font-bold text-gray-800">{{ $cancelados ?? 0 }}</p>
                            </div>
                            <div class="w-full bg-gray-200 rounded-full h-2">
                                <div class="bg-red-500 h-2 rounded-full" style="width: {{ $totalChamados > 0 ? (($cancelados ?? 0) / ($totalChamados ?? 1) * 100) : 0 }}%"></div>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                @unless(auth()->user()->isAluno())
                    <div class="mt-6">
                        <a href="{{ route('chamados.create') }}" class="w-full flex items-center justify-center gap-2 bg-senai-red hover:bg-red-700 text-white font-bold py-3 rounded-lg shadow-lg transition duration-200 hover:shadow-xl active:scale-95">
